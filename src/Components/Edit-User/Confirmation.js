...
import ConfirmIcon from '../../Components/UI/Confirmation';
...
//Buttons
const ConfirmationButtons = [buttons.large, buttons.RegisterButtons];
    ...
    return (
        ...
        */
        ...
        <ScrollView contentContainerStyle={ConfirmationSection}>
            ...
            <ConfirmIcon icon={Icon} text="Your details are ready to be submitted, would you like to submit them ?"/>
